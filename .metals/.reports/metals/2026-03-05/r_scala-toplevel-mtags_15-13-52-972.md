error id: file://<WORKSPACE>/Syntax.scala:[385..385) in Input.VirtualFile("file://<WORKSPACE>/Syntax.scala", "case class Instruction(operation: Operation, operand: Operand)

sealed trait Operation
case class xdv extends Operation
case class yxl extends Operation
case class yst extends Operation
case class jnz extends Operation
case class yxz extends Operation
case class out extends Operation
case class ydv extends Operation
case class zdv extends Operation

sealed trait Operand
case class 
")
file://<WORKSPACE>/file:<WORKSPACE>/Syntax.scala
file://<WORKSPACE>/Syntax.scala:15: error: expected identifier; obtained eof
